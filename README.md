...
玩家前进行驶时，车头相对当地赛道方向使用柔性角度保护：目标范围随速度从约 ±38° 收紧到 ±22°，提前 0.18 秒估计转向惯性造成的偏角。接近范围边缘时减弱向外转向，超出后通过前轮逐渐修正；不直接锁定车头、位置或增加抓地力。与轻度方向辅助不同，该保护在碰撞和路肩上仍生效；低速、倒车及大幅掉头时退出，保留脱困能力。它减少反打过度，不保证持续转向不会撞墙。测试覆盖左右蹭墙后反打、高速范围收紧、惯性预判和倒车退出。
